INSERT INTO customers VALUES(1, 'Akif','akif@gmail.com', '1234567890', 'Khulna', TO_DATE('1990-01-01', 'YYYY-MM-DD'));
INSERT INTO customers VALUES(2, 'tahim ','tahim@gmail.com', '9876543210', 'Dhaka', TO_DATE('1985-05-10', 'YYYY-MM-DD'));
INSERT INTO customers VALUES(3, 'Rana', 'rana@gmail.com', '5558755555', 'Rangpur', TO_DATE('1992-09-15', 'YYYY-MM-DD'));
...
( select 
     name,price,ROW_NUMBER() OVER(ORDER BY price DESC) AS rrow
     from products) 
WHERE rrow=2;
